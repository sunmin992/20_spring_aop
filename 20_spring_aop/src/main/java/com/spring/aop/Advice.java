...
public class Advice {
	...
	@Pointcut("execution(* work())") //중복되는 execution 기술
	public void abc() {
	...
	public void arroundGetWorkingTime(ProceedingJoinPoint pjp) throws Throwable {
		...
		System.out.println("업무소요 시간 : " + (endTime - startTime) + "초");
		System.out.println("==================");
